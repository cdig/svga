...
void main() {
    ...
    syncInternalTransform() {
      var currentScale, matrix, svgRect, tx, ty;
      ...
      svgRect = this.scopes.SVG.svg.getBoundingClientRect();
      ...
      this.wrapper.style.left = tx + this.options.panelSettings.x + "px";
      this.wrapper.style.top = ty + this.options.panelSettings.y + "px";
      ...
      return this.wrapper.style.transform = `scale(${currentScale})`;
    }
