(function() {
  ...
  Take(["Scope", "SVG", "Symbol"], function(Scope, SVG, Symbol) {
    ...
    return buildScopes = function(tree, setups, parentScope) {
      ...
      symbol = baseName.indexOf("Line") > -1 ? Symbol.forSymbolName("HydraulicLine") : baseName.indexOf("Field") > -1 ? Symbol.forSymbolName("HydraulicField") : Symbol.forInstanceName(props.id);
      if (symbol == null) {
        symbol = function() {
          return {};
        };
  ...
  Take(["Config", "ControlPanel", "Nav", "RAF", "Resize", "TopBar"], function(Config, ControlPanel, Nav, RAF, Resize, TopBar) {
    if (!Config.nav) {
      return;
    }
  ...
  Take(["Config", "Registry", "Gradient", "GUI", "Input", "Reaction", "Resize", "SVG", "TRS", "SVGReady"], function(Config, Registry, Gradient, GUI, Input, Reaction, Resize, SVG, TRS) {
  ...
  Take(["Config", "KeyMe", "Nav", "Tick"], function(Config, KeyMe, Nav, Tick) {
      ...
      Object.defineProperty(scope, 'pressure', {
        ...
        set: function(val) {
          if (pressure !== val) {
            pressure = val;
            if (isLine) {
              return scope.setHydraulicLinePressure(pressure);
            } else {
  ...
  Take(["Pressure", "Reaction", "SVG", "Symbol"], function(Pressure, Reaction, SVG, Symbol) {
    return Symbol("HydraulicLine", [], function(element) {
      var fillElms, scope, strip, strokeElms;
      strokeElms = [];
      fillElms = [];
      strip = function(elm) {
      ...
      return scope = {
        setHydraulicLinePressure: function(pressure) {
          var elm, len, len1, m, n, p, results;
          p = Pressure(pressure);
          ...
          for (n = 0, len1 = fillElms.length; n < len1; n++) {
            elm = fillElms[n];
            results.push(SVG.attr(elm, "fill", p));
          }
          return results;
        },
        setup: function() {
  ...
  Take(["Config", "ControlPanelLayout", "Gradient", "GUI", "Resize", "SVG", "Scope"], function(Config, ControlPanelLayout, Gradient, GUI, Resize, SVG, Scope) {
    ...
    return Make("ControlPanel", ControlPanelView = {
      show: function() {
        if (!showing) {
          showing = true;
          return SVG.append(GUI.elm, g.element);
        }
      },
  ...
  Take(["Action", "Config", "Reaction", "SVG", "DOMContentLoaded"], function(Action, Config, Reaction, SVG) {
    ...
    if (typeof Config.background === "string") {
      return SVG.style(target, "background-color", Config.background);
      ...
      return SVG.style(target, "background-color", "transparent");
    }
  });
